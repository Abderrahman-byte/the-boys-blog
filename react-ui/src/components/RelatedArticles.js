...
export const RelatedArticles = ({id}) => {
    ...
    const getArticles = async () => {
        ...
        const req = await fetch(`http://localhost:8000/api/getrelated?id=${id}`)
    ...
    return <AsideList data={serializedData} isLoading={isLoading} title='related posts' />
}